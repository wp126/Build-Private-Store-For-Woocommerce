	                    ...
	                    <table class="data_table">
	                        <tbody>
	                            ...
	                            <tr class="product_private">
	                                ...
	                                <td>
	                                	<select id="bpsfw_select_cats" name="bpsfw_cats_select2[]" multiple="multiple" style="width:60%;">
					                           	<?php
	                            ...
	                            <tr class="product_private">
	                                ...
	                                <td>
	                                	<select id="bpsfw_select_tags" name="bpsfw_tags_select2[]" multiple="multiple" style="width:60%;">
				                           	<?php
	                    ...
	                    <table class="data_table">
	                        <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<input type="text" name="bpsfw_comman[bpsfw_reject_email_subject]" value="<?php echo esc_attr($bpsfw_comman['bpsfw_reject_email_subject']);?>">
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<textarea rows="5" cols="30" name="bpsfw_comman[bpsfw_reject_email_message]"><?php echo esc_attr($bpsfw_comman['bpsfw_reject_email_message']);?></textarea>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<input type="text" name="bpsfw_comman[bpsfw_approve_email_subject]" value="<?php echo esc_attr($bpsfw_comman['bpsfw_approve_email_subject']);?>">
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<textarea rows="5" cols="30" name="bpsfw_comman[bpsfw_approve_email_message]"><?php echo esc_attr($bpsfw_comman['bpsfw_approve_email_message']);?></textarea>
	        ...
	        if( current_user_can('administrator') ) { 
	            if(isset($_REQUEST['bpsfw_private_store']) && $_REQUEST['bpsfw_private_store'] == 'bpsfw_save_option'){
	                ...
	                //if(!empty($_REQUEST['bpsfw_comman'])){
						...
						if(isset($_REQUEST['bpsfw_cats_select2'])){
		                   	$bpsfw_cats_select2 = BPSFW_recursive_sanitize_text_field( $_REQUEST['bpsfw_cats_select2']);
	        				update_option('wg_cats_select2', $bpsfw_cats_select2, 'yes');
						}else{
		            		update_option('wg_cats_select2', '', 'yes');
						}

						if(isset($_REQUEST['bpsfw_tags_select2'])){
		                   	$bpsfw_tags_select2 = BPSFW_recursive_sanitize_text_field( $_REQUEST['bpsfw_tags_select2']);
	        				update_option('bpsfw_tags_select2', $bpsfw_tags_select2, 'yes');
						}else{
		            		update_option('bpsfw_tags_select2', '', 'yes');
						}
